...
import org.gradle.api.tasks.TsSourceTask;
...
public abstract class TsAbstractCompile extends TsSourceTask {
  ...
  /**
   * Returns the directory property that represents the directory to generate the {@code .class}
   * files into.
   *
   ...
   * @deprecated Use {@link #getDestinationDirectory()} instead. This method will be removed in
   * Gradle 9.0.
   */
   ...
   * @deprecated Use {@link #getDestinationDirectory()}.set() instead. This method will be removed
   * in Gradle 9.0.
   */
  @Deprecated
